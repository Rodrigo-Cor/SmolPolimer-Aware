<template>
  ...
  [
    ...
    <article>
      <span>En cuanto a su origen, se pueden clasificar en primarios y
        secundarios.</span>
      ...
      ]" :headers="['Tipo', 'Características']" :img="true" />
    </article>
    <article>
      <InfoSection :img="{
  ...
  Unsplash:
    ...
    <article>
      ...
      <InformationPages :infoComponent="[
        {
          img: {
          ...
          arrayText: [
            [
              {
                value:
                  'Pueden adsorber y transferir contaminantes orgánicos debido a su capacidad por repeler el agua. Sumado a eso, su diminuto tamaño aumenta considerablemente la probabilidad de ingesta en organismos acuáticos, perjudicando su biología. Por otra parte, afectan la calidad de recursos hídricos y alimentos de consumo humano, ya que su propagación se puede dar en cualquier cuerpo de agua',
                link: [
                  {
                    text: '[5].',
                    id: 'home4',
    ...
    <article class="mt-2">
      ...
      <SectionReferences :view="'home'" :references="[
        {
        ...
        },
        {
          ...
          editorial: 'Int. J. Environ. Res. Public Health',
          vol: '19',
          no: '9',
          pages: [],
          yearPublication: '2022',
          link: 'https://doi.org/10.3390/ijerph19095283',
          dateAccess: '26-09-2023',
        },
      ]" />
    </article>
